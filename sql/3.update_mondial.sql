...
-- EXTENSION 1: Population with additional attributes

DROP TABLE IF EXISTS student38.population_extended CASCADE;

CREATE TABLE student38.population_extended AS
SELECT 
  c.code AS country,             -- e.g., 'D'
  c.name AS country_name,        -- e.g., 'Germany'
  c.population AS population,    -- current population
  2023 AS year                   -- fixed year
...
-- EXTENSION 2: Lakes with environmental & tourism data
...
-- Linking lakes to countries from Mondial
