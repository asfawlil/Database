...
-- Data basis for comparison & analysis in the Mondial extension
-- ---------------------------------------------------------------
...
-- Average salary (gross, annual income in local currency)
...
-- Legal minimum wage (monthly, if available)
-- Note: NULL means that no legal minimum wage exists
